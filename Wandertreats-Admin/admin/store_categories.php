            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>All Store Categories</h5>
                            <span>List of Partnered Stores Categories</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="row layout-wrap" id="layout-wrap">
                    ...
                    <?php for($x = 0 ; $x < count($merchantTypeData); $x++){ ?>
                    ...
                    <div class="col-12 list-item">
                        <div class="card d-flex flex-row mb-3">
                            <a class="d-flex card-img" href="#editLayoutItem" data-toggle="modal" data-target="#editLayoutItem">
                                <img src="<?= constants::BASE_URL."uploads/store/".$merchantsArray[$x]['vLogo'];?>" alt="<?= $merchantsArray[$x]['vLogo']; ?>" class="list-thumbnail responsive border-0">
                            ...
                            <div class="d-flex flex-grow-1 min-width-zero card-content">
                                <div class="card-body align-self-center d-flex flex-column flex-md-row justify-content-between min-width-zero align-items-md-center">
                                    <a class="list-item-heading mb-1 truncate w-40 w-xs-100" href="#editLayoutItem" data-toggle="modal" data-target="#editLayoutItem">
                                       <?= $merchantTypeData [$x]['vMerType']; ?>
                                    </a>
                                    <p class="mb-1 text-muted text-small category w-15 w-xs-100"><?= $merchantTypeData[$x]['vMerType']; ?></p>
                                    <p class="mb-1 text-muted text-small date w-15 w-xs-100">02.04.2018</p>
                                    <div class="w-15 w-xs-100">
                                        <span class="badge badge-pill badge-success"><?= $merchantTypeData[$x]['eStatus']; ?></span>
                                    </div>
                                </div>
