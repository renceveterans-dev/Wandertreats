                        ...
                        <div class="row">
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-lg-8 col-md-12">
                                                <h3 class="card-title">Visitors By Area</h3>
                                                <div id="visitfromworld" style="width:100%; height:350px"></div>
                                            </div>
                                            <div class="col-lg-4 col-md-12">
                                                <div class="row mb-15">
                                                    <div class="col-9">Ilayang Ilasan</div>
                                                ...
                                                <div class="row mb-15">
                                                    <div class="col-9">Ibabang Ilasan</div>
                                                    <div class="col-3 text-right">11%</div>
                                                    <div class="col-12">
                                                        <div class="progress progress-sm mt-5">
                            ...
                            <div class="col-md-4">
                                <div class="card" style="min-height: 422px;">
                                    <div class="card-header"><h3>User Chart</h3></div>
                                    <div class="card-body">
