	                ...
	                <div class="card-body">
	                    <form class="forms-sample">
	                        <div class="form-group row">
	                            ...
	                            <div class="col-sm-9">
 									<input type="text" class="form-control user-input-text" id="Firstname" placeholder="Firstname" value="<?= $user['vName']; ?>">
	                            </div>
	                        ...
	                        <div class="form-group row">
	                            ...
	                            <div class="col-sm-9">
 									<input type="text" class="form-control user-input-text" id="Lastname" placeholder="Lastname" value="<?= $user['vLastName']; ?>">
	                            </div>
	                        ...
	                        <div class="form-group row">
	                            ...
	                            <div class="col-sm-9">
 									<input type="email" class="form-control user-input-text" id="Email" placeholder="Email" value="<?= $user['vEmail']; ?>">
	                            </div>
	                        ...
	                        <div class="form-group row">
	                            ...
	                            <div class="col-sm-9">
 									<input type="number" class="form-control user-input-text" id="MobileNumber" lenght="11" placeholder="09XXXXXXXXX" value="<?= $user['vPhone']; ?>">
	                            </div>
	                        ...
	                        <div class="form-group row">
	                            ...
	                            <div class="col-sm-9">
 									<input type="Country" class="form-control user-input-text" id="Country" placeholder="Country" value="<?= $user['vState']; ?>">
	                            </div>
	                        ...
	                        <div class="form-group row">
	                            ...
	                            <div class="col-sm-9">
 									<input type="Region" class="form-control user-input-text" id="Region" placeholder="Region" value="<?= $user['vRegion']; ?>">
	                            </div>
	                        ...
	                        <div class="form-group row">
	                            ...
	                            <div class="col-sm-9">
 									<input type="City" class="form-control user-input-text" id="City" placeholder="City" value="<?= $user['vCity']; ?>">
	                            </div>
							...
							<div class="form-group row">
	                            <label for="Gender" class="col-sm-3 col-form-labels">Gender</label>
	                           	<div class="col-sm-9">
									<select class="form-control user-input-text" id="Gender">
                                		<option value="Male" <?= $user['eGender'] == 'Male' ? 'selected' : ''; ?> >Male</option>
                                		<option value="Female" <?= $user['eGender'] == 'Female' ? 'selected' : ''; ?> >Female</option>
                                		<option value="Others" <?= $user['eGender'] == 'Others' ? 'selected' : ''; ?> >Others</option>
                                	</select>
                                </div>
	                        </div>
	                        ...
	                        <div class="form-group row">
	                            ...
	                            <div class="col-sm-9">
	                        	 	<select class="form-control user-input-text" id="EmailVerified">
                              
                                		<option value="Yes" <?= $user['eEmailVerified'] == 'Yes' ? 'selected' : ''; ?> >Yes</option>
                                		<option value="No" <?= $user['eEmailVerified'] == 'No' ? 'selected' : ''; ?> >No</option>
	                        ...
	                        <div class="form-group row">
	                            ...
	                            <div class="col-sm-9">
	                        	 	<select class="form-control user-input-text" id="PhoneVerified">
                              
	                            		<option value="Yes" <?= $user['ePhoneVerified'] == 'Yes' ? 'selected' : ''; ?> >Yes</option>
	                            		<option value="No" <?= $user['ePhoneVerified'] == 'No' ? 'selected' : ''; ?> >No</option>
	                        ...
	                        <div class="form-group row">
	                        	 ...
	                        	 <div class="col-sm-9">
	                        	 	<input type="ReferralCode" class="form-control user-input-text" id="ReferralCode" placeholder="EmailVerified" value="<?= $user['vRefCode']; ?>">
	                        	 </div>
                          	...
                          	<div class="form-group row">
	                            ...
	                            <div class="col-sm-9">
	                            	<select class="form-control user-input-text" id="Logout">
                          
	                            		<option value="Yes" <?= $user['eLogout'] == 'Yes' ? 'selected' : ''; ?> >Yes</option>
	                            		<option value="No" <?= $user['eLogout'] == 'No' ? 'selected' : ''; ?> >No</option>
	                        ...
	                        <div class="form-group row">
	                            ...
	                            <div class="col-sm-9">
 									<select class="form-control user-input-text" id="Blocked">
                          
	                            		<option value="Yes" <?= $user['eIsBlocked'] == 'Yes' ? 'selected' : ''; ?> >Yes</option>
	                            		<option value="No" <?= $user['eIsBlocked'] == 'No' ? 'selected' : ''; ?> >No</option>
	                        ...
	                        <div class="form-group row" class="col-sm-3 col-form-label">
	                            ...
	                            <div class="col-sm-9">
 									<input type="number" class="form-control user-input-text" id="AppVersion" placeholder="App Version" value="<?= $user['iAppVersion']; ?>">
	                            </div>
	                        ...
	                        <div class="form-group row">
	                            ...
	                            <div class="col-sm-9">
 									<input type="text" class="form-control user-input-text" id="DeviceData" placeholder="Device Data" value="<?= $user['tDeviceData']; ?>">
	                            </div>
	                        </div>
	                ...
	                <div class="card-body">
	                   	<form class="forms-sample" id="storeBannerForm" method="post" enctype="multipart/form-data">
							<div class="form-group">
		                        ...
		                        <input type="file" name="filePhoto" id="filePhoto" class="file-upload-default">
		                        <div class="input-group col-xs-12">
		                            <input type="text" id="ProfilePhotoName" class="form-control file-upload-info" disabled placeholder="Upload Image" value="<?= $user['vImage'];?>">
		                            <span class="input-group-append">
		                            <button class="file-upload-browse btn btn-default" type="button">Choose</button>
		                             <button type="button" id="uploadProfilePhoto" class="btn btn-primary" type="button">Upload</button>
		                            </span>
		                            </span>
 				...
 				<div class="card">
	                ...
	                <div class="card-body">
	                   	<div class="form-group row">
                            ...
                            <label class="col-sm-3 col-form-label">Delete this Account</label>
                            <div class="col-sm-9">
