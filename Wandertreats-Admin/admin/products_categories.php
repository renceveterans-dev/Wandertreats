 <?php 
    ...
    for($x = 0; $x < count($productCategory); $x ++){
        ...
        $dataArr[$x] = $productCategory[$x];

        $sql = "SELECT count(*) as totalCount FROM products WHERE iCategoryId = '".$productCategory[$x]['iCategoryId']."'"; 
        $statement = $obj->query($sql); 
        $productTotalCount = $statement ->fetchAll();

        $dataArr[$x]['productCount'] = $productTotalCount[0]['totalCount'];
            ...
            <div class="card-header row">
                <div class="col col-sm-3">
                    <div class="card-options d-inline-block">
                        ...
                        <a href="products_categories_add.php"><i class="ik ik-plus"></i></a>
                ...
                <table id="advanced_table" class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $dataArr[$x]['vCategoryName']; ?></td>
                            <td><?= $dataArr[$x]['productCount']; ?></td>
                            <td><span class="badge badge-pill badge-success"><?= $dataArr[$x]['eStatus']; ?></span></td>
