		...
		<div class="card">
	        <div class="card-header row">
	            <div class="col col-sm-3">
	                <div class="card-options d-inline-block">
	                    ...
	                    <a href="user_add.php"><i class="ik ik-plus"></i></a>
	        ...
	        <div class="card-body">
	            <table id="advanced_table" class="table">
	                ...
	                <?php for($x = 0 ; $x < count($registerUsers); $x++){ ?>

	                <?php $user = $registerUsers[$x]; ?>
	                    <tr>
	                        <td>
	                        ...
	                        <td><?= $user['vName']." ".$user['vLastName']; ?> </td>
	                        <td><?= $user['vCity']; ?></td>
	                       
	                        <td><?= $user['vPhone']; ?></td>
	                        <td><?= $user['eStatus']; ?></td>
	                        <td><?= $user['dRegistrationDate']; ?></td>
	                         <td>
                                <div class="list-actions">
                                    <a href="user_view.php?id=<?= $user['iUserId']; ?>">  &nbsp;<i class="ik ik-eye"></i></a>&nbsp;&nbsp;
                                    <a href="user_edit.php?id=<?= $user['iUserId']; ?>">  &nbsp;<i class="ik ik-edit-2"></i></a>&nbsp;&nbsp;
                                    <span onclick="deleteItem('iUserId', <?= $user['iUserId']; ?>, 'register_user')" id="Delete" class="list-delete">  <i class="ik ik-trash-2"></i></span>
                                </div>
                            </td>
                            <td></td>
	                    </tr>
