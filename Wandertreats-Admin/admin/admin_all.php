 <?php 
    ...
    $sql = "SELECT * FROM administrator WHERE eStatus != 'Deleted' "; 
            ...
            <div class="card-body">
                <table id="advanced_table" class="table">
                    ...
                    <tbody>
                        ...
                        <?php  $admin = $administrators[$x]; ?>
                        <?php  $adminId = $admin['iAdminId']; ?>
                        ...
                        <tr>
                            ...
                            <td><?= $admin['vFirstName']." ".$admin['vLastName']; ?></td>
                            <td><?= $admin['vFirstName']." ".$admin['vLastName']; ?></td>
                            <td><?= $admin['vEmail']; ?></td>
                            <td><?= $admin['vMobile']; ?></td>
                            <?php $badgeInfo = $admin['eStatus'] == 'Active' ? 'badge-success' : 'badge-danger'; ?>
                            <td><span class="badge badge-pill <?= $badgeInfo; ?>"><?= $admin['eStatus']; ?></span></td></td>


                            <td>
                                <div class="list-actions">
                                    <a href="admin_view.php?id=<?= $adminId; ?>">  &nbsp;<i class="ik ik-eye"></i></a>&nbsp;&nbsp;
                                    <a href="admin_edit.php?id=<?= $adminId; ?>">  &nbsp;<i class="ik ik-edit-2"></i></a>&nbsp;&nbsp;
                                    <a href="#" class="list-delete"  onclick="deleteItem('iAdminId', <?= $adminId; ?>, 'administrator')" role="button">  <i class="ik ik-trash-2"></i></a>
                                </div>
                            </td>
                             <td></td>
                        </tr>
