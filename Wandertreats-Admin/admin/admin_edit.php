                ...
                <div class="col-lg-4">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit Administratorr</li>
                        </ol>
                    </nav>
                </div>
            </div>
	                ...
	                <div class="card-body">
	                    <form class="forms-sample">
	                    	<div class="form-group row">
	                            ...
	                            <div class="col-sm-9">
	                                <input type="text" class="form-control admin-inputbox-text" id="Username" placeholder="Username" value="<?= $admin['vUserName']; ?>">
	                        ...
	                        <div class="form-group row">
	                            ...
	                            <div class="col-sm-9">
	                                <input type="text" class="form-control admin-inputbox-text" id="Email" placeholder="Email" value="<?= $admin['vEmail']; ?>">
	                            </div>
	                        </div>


	                        <div class="form-group row">
                                <label for="exampleInputMobile" class="col-sm-3 col-form-label">Admin Status</label>
                                <div class="col-sm-9">
                                	<select class="form-control admin-inputbox-text" id="Status">


                                		<option value="Active" <?= ($admin['eStatus'] == "Active" ) ? 'selected' : '' ; ?> >Active</option>

                                		<option value="Inactive" <?= ($admin['eStatus'] == "Inactive" ) ? 'selected' : '' ; ?> >Inactive</option>

                                		<option value="Deleted" <?= ($admin['eStatus'] == "Deleted" ) ? 'selected' : '' ; ?> >Deleted</option>
	                        ...
	                        <div class="form-group row">
	                            ...
	                            <div class="col-sm-9">
	                                <input type="password" class="form-control admin-inputbox-text" id="Password" placeholder="Email" value="<?= $admin['vPassword']; ?>">
	                            </div>
	                        </div>
	                        <div class="form-group row">
	                            <label for="Firstname" class="col-sm-3 col-form-label">Retype Password</label>
	                            <div class="col-sm-9">
	                                <input type="password" class="form-control admin-inputbox-text" id="RetypePassword" placeholder="Email" value="<?= $admin['vPassword']; ?>">
	                            </div>
	                        </div>
	                ...
	                <div class="card-body">
	                    <form class="forms-sample">
	                        <div class="form-group row">
	                            ...
	                            <div class="col-sm-9">
	                                <input type="text" class="form-control admin-inputbox-text" id="Firstname" placeholder="Firstname" value="<?= $admin['vFirstName']; ?>">
	                            </div>
	                        </div>
	                        <div class="form-group row">
	                            <label for="Lastname" class="col-sm-3 col-form-label">Lastname</label>
	                            <div class="col-sm-9">
	                                <input type="text" class="form-control admin-inputbox-text" id="Lastname" placeholder="Lastname" value="<?= $admin['vLastName']; ?>">
	                            </div>
	                        </div>
	                        ...
	                        <div class="form-group row">
	                            ...
	                            <div class="col-sm-9">
	                                <input type="text" class="form-control admin-inputbox-text" id="Mobile" placeholder="Mobile number" value="<?= $admin['vMobile']; ?>">
	                            </div>
	                        </div>
	                        ...
	                        <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                	<select class="form-control admin-inputbox-text" id="AdminLevel">


                                		<option value="Admin" <?= ($admin['vAdminLevel'] == "Admin" ) ? 'selected' : '' ; ?> >Admin</option>

                                		<option value="Biller" <?= ($admin['vAdminLevel'] == "Biller" ) ? 'selected' : '' ; ?> >Biller</option>
