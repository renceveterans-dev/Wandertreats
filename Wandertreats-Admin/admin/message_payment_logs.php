 <?php 
    ...
    $sql = "SELECT * FROM sms_transaction_logs"; 
    $statement = $obj->query($sql); 
    $transactionArr = $statement ->fetchAll();
                ...
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            ...
                            <span>View payment transactions logs and payment details </span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
         ...
         <div class="card">
            <div class="card-header row">
               ...
               <!--          <a href="#"><i class="ik ik-plus"></i></a> -->
                        <a href="message_payment_logs.php"><i class="ik ik-rotate-cw"></i></a>
                        <div class="dropdown d-inline-block">
            ...
            <div class="card-body p-0">
                <div class="list-item-wrap">
                    ...
                    <?php for($x = 0 ; $x < count($transactionArr); $x++){ ?>
                    <?php   $logs = $transactionArr[$x]; ?>
                    ...
                    <div class="list-item">
                        <div class="item-inner">
                            ...
                            <div class="list-title"><a href="javascript:void(0)"><?=  $logs['vSender']; ?></a></div>
                            <div class="list-title"><a href="javascript:void(0)"><?=  $logs['vAmount']; ?></a></div>
                            <div class="list-title"><a href="javascript:void(0)"><?=  $logs['vReferenceNo']; ?></a></div>
                            <div class="list-title"><a href="javascript:void(0)"><?=  $logs['dDateSent']; ?></a></div>
                    ...
                    <?php if(count($transactionArr) <= 0){ ?>
                
                        <div class="alert alert-warning" role="alert">
                        No Payment Transaction logs.
                        </div>
