                ...
                <table id="advanced_table" class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="<?= constants::BASE_URL."uploads/products/".$productsArr[$x]['iProductId']."/".$productsArr[$x]['vImages'][0]['vImage'];?>" class="table-user-thumb" alt="<?= $productsArr[$x]['vImages'][0]['vImage'];?>"></td>
                            <td><?= $prod['vProductName']; ?></td>
                            <td><?= number_format($prod['fPrice'],2); ?></td>
                            <td><?= number_format($prod['fDiscount'],2); ?></td>
                            <td><?= $prod['iTotalSold']; ?></td>
                            <td><?= $prod['iStocks']; ?></td>
                            <td><?= $prod['vStoreName']; ?></td>
                            <td><?= $prod['eStatus']; ?></td>
                    
                            <td>
                                <div class="list-actions">
                                    <a href="products_view.php?id=<?= $prod['iProductId']; ?>"> View &nbsp;<i class="ik ik-eye"></i></a>&nbsp;&nbsp;
                                    <a href="products_edit.php?id=<?= $prod['iProductId']; ?>"> Edit &nbsp;<i class="ik ik-edit-2"></i></a>&nbsp;&nbsp;
                                    <a href="#" class="list-delete" role="button" onclick="deleteItem('iProductId', <?= $prod['iProductId']; ?>, 'products')"> Delete <i class="ik ik-trash-2"></i></a>
                                </div>
                            </td>
                             <td></td>
                        </tr>
