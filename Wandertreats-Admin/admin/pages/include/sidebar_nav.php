  <div class="app-sidebar colored">
	<div class="sidebar-header">
		<a class="header-brand" href="../dashboard.php">
			<div class="logo-img">
			   <img width="30px" height="30px" src="https://wanderlustphtravel.com//wandertreats/uploads/logo.png" class="header-brand-img" alt=""> 
			</div>
			<span class="text">Wandertreats</span>
		</a>
		...
		<div class="nav-container">
			<nav id="main-menu-navigation" class="navigation-main">
				...
				<div class="nav-item has-sub">
					...
					<div class="submenu-content">
						<a href="admin.php" class="menu-item">All admin</a>
						<a href="agents.php" class="menu-item">Agents</a>
				...
				<div class="nav-item has-sub">
					...
					<div class="submenu-content">
						<a href="stores/all_stores.php" class="menu-item">All Stores</a>
						<a href="pages/ui/badges.html" class="menu-item">Categories</a>
					</div>
				</div>
				<div class="nav-item has-sub">
					<a href="#"><i class="ik ik-gitlab"></i><span>Users</span> <span class="badge badge-success">New</span></a>
					<div class="submenu-content">
						<a href="pages/ui/rating.html" class="menu-item">All Users</a>
						<a href="pages/ui/modals.html" class="menu-item">By Location</a>
						<a href="pages/ui/carousel.html" class="menu-item">By Gender</a>
						<a href="pages/ui/range-slider.html" class="menu-item">By Age</a>
...
<!-- 				<div class="nav-item has-sub">
				...
				<div class="nav-item">
					<a href="feed-post.php"><i class="ik ik-slash"></i><span>Feed Post</span></a>
				</div>
