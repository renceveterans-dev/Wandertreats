		...
		<div class="nav-container">
			<nav id="main-menu-navigation" class="navigation-main">
				...
				<div class="nav-item has-sub">
					...
					<div class="submenu-content">
						<a href="pages/ui/alerts.html" class="menu-item">All admin</a>
						<a href="pages/ui/badges.html" class="menu-item">Agents</a>
				...
				<div class="nav-item has-sub">
					...
					<div class="submenu-content">
						<a href="pages/ui/alerts.html" class="menu-item">All Stores</a>
