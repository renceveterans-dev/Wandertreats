...
header('Content-type: application/json');
    ...
    $longitude  = isset($_REQUEST['longitude']) ? trim($_REQUEST['longitude']) : '';
    $merchantType = isset($_REQUEST['merchantType']) ? trim($_REQUEST['merchantType']) : '';

    
    $sql = "SELECT mt.iTypeId, mt.vMerType, me.* FROM merchant_types as mt LEFT JOIN merchants as me ON mt.iTypeId = me.iTypeId WHERE me.vStoreName != '' AND me.eStatus = 'Active'"; 
