...
import com.wandertech.wandertreats.store.PurchaseConfirmationActivity;
import com.wandertech.wandertreats.store.databinding.ActivityGcashPaymentBinding;
import com.wandertech.wandertreats.store.databinding.ActivityNotificationDetailsBinding;
...
public class GCashPaymentActivity extends BaseActivity {
    ...
    public void onBackPressed() {
        ...
        if(getIntent().getStringExtra("isStart").equals("checkout")){
            Bundle bn =  new Bundle();
        ...
        if(getIntent().getStringExtra("isStart").equals("details")){
            super.onBackPressed();
        }
    }
